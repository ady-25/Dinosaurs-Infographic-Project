...
class Dinosaurs {
    ...
    compareHeight(humanHeight, humanName) {
        this.fact2 = this.species + " is " + (this.height > humanHeight ? "taller" : "shorter") + " than " + humanName + "!";
    }
    compareWeight(humanWeight, humanName) {
        this.fact3 = this.species + " is " + (this.weight > humanWeight ? "bigger" : "smaller") + " than " + humanName + "!";
    }
    compareDiet(humanDiet, humanName) {
        this.fact4 = this.species + " has a " + (this.diet === humanDiet ? "similar" : "different") + " diet compared to " + humanName + "!";
    }
}
...
async function makeTiles(human) {
    ...
    dinoData.forEach(dino => { // loopinhg through the dino array
        ...
        if (dino.species === "Human") {
            ...
            tile.innerHTML = `
                ...
                <div class="details">
                    <ul>
                        <li>Height: ${Math.floor(dino.height / 12)}' ${dino.height % 12}"</li>
...
(function() {
    ...
    button.addEventListener('click', function() {
        ...
        const humanHeight = (parseInt(humanFeet.value) * 12) + parseInt(humanInches.value);
